  ...
  return (
    <button
      ...
      className={classNamesTailwind(
        'flex-none border border-gray-300 border-l-0 pr-3 pl-2 rounded-r ',
        autocomplete?.button,
        {
    ...
    >
      <div
        className={classNamesTailwind('relative', {
        ...
        {geoLocationVerified && (
          <>
            <svg
              ...
              className="fill-green-500 w-4 h-4 absolute -top-1 -right-2"
            >
